...
function AccordionSection() {
  ...
  const data = {
    rows: [
      ...
      {
        title: "How to create an account on Auqta?",
        content: (
          <AnswerSection
            content={
      ...
      {
        title: "Can I change my personal details?",
        content: (
          <AnswerSection
            content={
      ...
      {
        title: "How to add a property on Auqta?",
        content: (
          <AnswerSection
            content={
      ...
      {
        title: "How to view properties on Auqta?",
        content: (
          <AnswerSection
            content={
      ...
      {
        title: "How to use Augmented Reality?",
        content: (
          <AnswerSection
            content={
